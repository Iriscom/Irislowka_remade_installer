...
public class testrScreenHandler extends ScreenHandler {
    ...
    public final Inventory input = new SimpleInventory(1) {
        ...
        public void markDirty() {
            super.markDirty();
            net.iristeam.storycore.client.gui.testrScreenHandler.this.onContentChanged(this);
            net.iristeam.storycore.client.gui.testrScreenHandler.this.contentsChangedListener.run();
        }
    };
    final CraftingResultInventory output = new CraftingResultInventory();

    public testrScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public testrScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        ...
        this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ...
                net.iristeam.storycore.client.gui.testrScreenHandler.this.output.unlockLastRecipe(player, this.getInputStacks());
                ItemStack itemStack = net.iristeam.storycore.client.gui.testrScreenHandler.this.inputSlot.takeStack(1);
                if (!itemStack.isEmpty()) {
                    net.iristeam.storycore.client.gui.testrScreenHandler.this.populateResult();
                }

                context.run((world, pos) -> {
                    long l = world.getTime();
                    if (net.iristeam.storycore.client.gui.testrScreenHandler.this.lastTakeTime != l) {
                        world.playSound(null, pos, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        net.iristeam.storycore.client.gui.testrScreenHandler.this.lastTakeTime = l;
                    }
                });
            ...
            private List<ItemStack> getInputStacks() {
                return List.of(net.iristeam.storycore.client.gui.testrScreenHandler.this.inputSlot.getStack());
            }
        });
